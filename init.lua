...
vim.keymap.set('i', "j9", ":")
vim.keymap.set('i', "j0", ";")
vim.keymap.set('i', "jja", "<ESC>A;<ESC>")
vim.keymap.set('i', "j-", "#")
vim.keymap.set('i', "jg", "=")
vim.keymap.set('i', "j.", "->")
vim.keymap.set('i', "jr", "=>")
vim.keymap.set('i', "jq", '""<ESC>i')
vim.keymap.set('i', "jl", "{}<ESC>i")
vim.keymap.set('i', "jh", "()<ESC>i")
vim.keymap.set('i', "jn", ".")
vim.keymap.set('i', "jm", ",")
vim.keymap.set('i', "jt", "<div></div><ESC>hcit")
vim.keymap.set('i', "jtt", "<ESC>lciw<<ESC>pla/><ESC>")
vim.keymap.set('i', "je", "<ESC>ciw<><ESC>PA</><ESC>Pcit<C-j><ESC>O<ESC>4li")
vim.keymap.set('i', "jcc", "console.log()<ESC>hp")
vim.keymap.set('i', "jpt", 'println!("{}");<ESC>3hi')
vim.keymap.set('i', "jw", '<ESC>:w!<cr>li')

vim.keymap.set('n', "<A-e>", ":Ex<cr>")
